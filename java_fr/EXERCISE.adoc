...
* Créer un nouveau dépôt Git public sur la plateforme GitHub avec le nom **java_exercise_1** [.underline]#initialisé# avec un fichier README.md (case à cocher dans le formulaire de création de dépôt)
